  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-zinc-100 flex flex-col font-sans">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden lg:flex items-center space-x-3 text-xs font-mono text-zinc-400 border-r border-zinc-800 pr-4">
              <Link href="/ops" className="hover:text-amber-400 flex items-center space-x-1 transition-colors">
      ...
      <div className="md:hidden flex border-b border-zinc-800/80 bg-zinc-900/60 px-4 py-2 font-mono text-xs space-x-2 overflow-x-auto">
        <Link href="/studio" className="px-2.5 py-1 rounded bg-zinc-800 text-purple-400 whitespace-nowrap">
          Creator Lab
        </Link>
        <Link href="/studio/sales" className="px-2.5 py-1 rounded hover:bg-zinc-800 text-zinc-400 whitespace-nowrap">
          Sales & Royalties
        </Link>
        <Link href="/studio/payouts" className="px-2.5 py-1 rounded hover:bg-zinc-800 text-zinc-400 whitespace-nowrap">
          Payouts
        </Link>
      </div>
