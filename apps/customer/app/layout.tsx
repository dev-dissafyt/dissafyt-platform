                ...
                <div className="container mx-auto max-w-7xl px-4 sm:px-6">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-zinc-900">
                    <div className="md:col-span-2 space-y-4">
                      <Link href="/" className="inline-block transition-transform duration-200 hover:scale-[1.02] active:scale-95">
                        <Image
                          src="/logo.png"
                          alt="Dissafyt"
                          width={150}
                      ...
                      {/* VIP Drop List Newsletter Signup */}
                      <div className="pt-2">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-xs text-zinc-400">
                        ...
                        <li className="pt-2">
                          <OutboundLink
                            href="https://maps.google.com/?q=Cape+Town+Western+Cape+South+Africa"
                  ...
                  <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-zinc-600 gap-3">
                    ...
                    <div className="font-mono text-[11px] text-zinc-500">
                      <OutboundLink href="https://payfast.io" className="hover:text-amber-400">
