...
import { Scissors, Lock, ArrowRight, ShieldCheck, UserCheck, Shield } from 'lucide-react';
          ...
          <div className="pt-2 border-t border-zinc-800/80 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="text-left p-2 rounded-xl bg-zinc-950 border border-zinc-800 hover:border-amber-500/50 transition-colors flex items-center gap-2 group cursor-pointer"
              >
                ...
                <div className="truncate">
                  <div className="text-xs font-semibold text-white group-hover:text-amber-400 truncate">Curtis-Lee</div>
                  <div className="text-[9px] text-zinc-500 font-mono truncate">Master Barber</div>
                </div>
              </button>
              ...
              <button
                type="button"
                onClick={() => {
                  setEmail('dissafyt@gmail.com');
                  setPassword('Wat07081');
                }}
                className="text-left p-2 rounded-xl bg-zinc-950 border border-zinc-800 hover:border-rose-500/50 transition-colors flex items-center gap-2 group cursor-pointer"
              >
                ...
                <div className="truncate">
                  <div className="text-xs font-semibold text-white group-hover:text-rose-400 truncate">Dissafyt Admin</div>
                  <div className="text-[9px] text-zinc-500 font-mono truncate">Executive Owner</div>
                </div>
              </button>
            </div>
          </div>
